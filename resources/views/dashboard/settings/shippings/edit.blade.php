                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin/edit.ShippingMethod')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('admin/edit.UpdateShippingMethod')}} </h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/edit.Name')}} </label>
                                                    ...
                                                    <div class="class col-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/edit.DeliveryValue')}}</label>
