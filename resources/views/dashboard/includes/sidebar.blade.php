    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('admin/sidebar.Sections')}} </span>
                    <span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.Categories.create')}}" data-i18n="nav.dash.crypto"> {{__('admin/sidebar.AddNewSection')}}</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-group"></i>
